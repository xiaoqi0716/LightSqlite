/*
 * File Name: AbstractTable.java 
 * History:
 * Created by Siyang.Miao on 2012-3-3
 */
...
public abstract class AbstractTable<T> {
    ...
    protected void setDBHelper(AbstractDBHelper helper) {
        mHelper = helper;
    }

    private AbstractDBHelper.DBHelperProxy getDataBase() {
        if (mHelper == null) {
            mHelper = AbstractDBHelper.getDBHelper(getTableName());
            if (mHelper == null) {
     ...
     * @return
     */
    public List<T> find(String where, String groupBy, String having, String orderBy, int limit) {
        if (limit <= 0) {
            return find(null, where, groupBy, having, orderBy, null, null);
        }
        return find(null, where, groupBy, having, orderBy, limit + "", null);
    }
     ...
     * @return
     */
    public List<T> find(String where, String groupBy, String having, String orderBy) {
        return find(null, where, groupBy, having, orderBy, null, null);
    }
     ...
     * @return
     */
    public List<T> find(String[] columns, String where, String groupBy, String having, String orderBy, int limit) {
        if (limit <= 0) {
            return find(columns, where, groupBy, having, orderBy, null, null);
        }
        return find(columns, where, groupBy, having, orderBy, limit + "", null);
    }
     ...
     * @return
     */
    public List<T> find(String[] columns, String where, String groupBy, String having, String orderBy) {
        return find(columns, where, groupBy, having, orderBy, null, null);
    }
    ...
    public T findOne(String where) {
        List<T> data = find(null, where, null, null, null, "1", null);
     ...
     * @return
     */
    public T findOne(String[] columns, String where) {
        List<T> data = find(columns, where, null, null, null, "1", null);
        if (data != null && data.size() > 0) {
            return data.get(0);
        }
        return null;
     ...
     * @return
     */
    public T findOne(String[] columns, String where, String orderby) {
        List<T> data = find(columns, where, null, null, orderby, "1", null);
        if (data != null && data.size() > 0) {
            return data.get(0);
        }
        return null;
     ...
     * @return 成功插入记录的数量, 异常返回{@link #EXCEPTION_CODE}
     */
    public int add(List<T> data, boolean isBeginTransaction) {
        int insertNum = 0;
     ...
     * @return 成功更新记录的数量, 异常返回{@link #EXCEPTION_CODE}
     */
    public int set(T data, String where) {
        int row = 0;
        try {
            SQLiteDatabase db = getDataBase().getWritableDatabase();
            ContentValues values = createContentValues(data);
     ...
     * @return 成功更新记录的数量, 异常返回{@link #EXCEPTION_CODE}
     */
    public int set(String where, String field[], Object... value) {
     ...
     * @return 成功更新记录的数量, 异常返回{@link #EXCEPTION_CODE}
     */
    public int set(String field, String value, String where) {
        int row = 0;
        try {
            SQLiteDatabase db = getDataBase().getWritableDatabase();
            ContentValues values = new ContentValues();
     ...
     * @return
     */
    public int set(String field, int value, String where) {
        int row = 0;
        try {
            SQLiteDatabase db = getDataBase().getWritableDatabase();
            ContentValues values = new ContentValues();
     ...
     * @return 成功更新记录的数量, 异常返回{@link #EXCEPTION_CODE}
     */
    public int set(String field, boolean value, String where) {
        int row = 0;
        try {
            SQLiteDatabase db = getDataBase().getWritableDatabase();
            ContentValues values = new ContentValues();
     ...
     * @return 成功更新记录的数量, 异常返回{@link #EXCEPTION_CODE}
     */
    public int set(String field, float value, String where) {
        int row = 0;
        try {
            SQLiteDatabase db = getDataBase().getWritableDatabase();
            ContentValues values = new ContentValues();
     ...
     * @return 成功更新记录的数量, 异常返回{@link #EXCEPTION_CODE}
     */
    public int set(String field, double value, String where) {
        int row = 0;
        try {
            SQLiteDatabase db = getDataBase().getWritableDatabase();
            ContentValues values = new ContentValues();
     ...
     * @return 成功更新记录的数量, 异常返回{@link #EXCEPTION_CODE}
     */
    public int set(String field, long value, String where) {
        int row = 0;
        try {
            SQLiteDatabase db = getDataBase().getWritableDatabase();
            ContentValues values = new ContentValues();
     ...
     * @return 成功更新记录的数量, 异常返回{@link #EXCEPTION_CODE}
     */
    public int set(String field, byte value, String where) {
        int row = 0;
        try {
            SQLiteDatabase db = getDataBase().getWritableDatabase();
            ContentValues values = new ContentValues();
