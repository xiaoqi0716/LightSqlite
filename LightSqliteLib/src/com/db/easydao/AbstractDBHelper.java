/*
 * File Name: AbstractDBHelper.java 
 * History:
...
public abstract class AbstractDBHelper {
    ...
    private List<AbstractTable<?>> mTables = new ArrayList<AbstractTable<?>>();
    private static Map<String, AbstractDBHelper> tableMap = new HashMap<String, AbstractDBHelper>();
    ...
    public final void open() {
        ...
        List<AbstractTable<?>> temp = getTables();
        ...
        for (AbstractTable<?> table : mTables) {
    ...
    protected static AbstractDBHelper getDBHelper(String tableName) {
        synchronized (tableMap) {
    ...
    class DBHelperProxy extends SQLiteOpenHelper {
        ...
        public DBHelperProxy(Context context, String name, CursorFactory factory, int version) {
